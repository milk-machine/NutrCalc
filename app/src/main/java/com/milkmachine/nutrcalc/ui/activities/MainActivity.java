...
public class MainActivity extends AppCompatActivity
    ...
    class TabsAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int i) {
            switch(i) {
                case 0: return StatisticFragment.newInstance();
                case 1: return StatisticFragment.newInstance();
                case 2: return StatisticFragment.newInstance();
            }
            return null;
        }
        ...
        public CharSequence getPageTitle(int position) {
            switch(position) {
                case 0: return getResources().getString(R.string.today);
                case 1: return getResources().getString(R.string.week);
                case 2: return getResources().getString(R.string.year);
            }
            return "";
        }
    }
